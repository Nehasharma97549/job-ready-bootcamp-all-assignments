/*9- define a class bill and define its member function get() to take detail of customer calculatebill() function to calculate electricity bill using below tarif.
